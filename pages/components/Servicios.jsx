      ...
      <section>
        ...
        <div className='lg:flex gap-10 px-8 md:px-14'>
          <div className='text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1'>
            ...
            <p className='py-2'>
              Creo tu página web o aplicación desde cero, utilizando los
              lenguajes de programación más adecuados y modernos.
            </p>
          ...
          <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
            ...
            <p className='py-2'>
              He trabajado para múltiples blogs de España como redactor y
              editor. Tengo más de 4 años de experiencia en el ámbito laboral.
            </p>
