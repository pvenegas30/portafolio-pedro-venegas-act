...
export const Inicio = () => {
  return (
    <div>
      <div className='text-center p-14 py-28 md:px-10 lg:px-20'>
        <h2 className='text-4xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-5xl ml:text-6xl'>
          Pedro Venegas
        </h2>
        <h3 className='text-2xl py-2 font-semibold dark:text-white md:text-3xl'>
          Desarrollador Web 
          Full-Stack
        </h3>
        <p className='text-justify text-lg py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl '>
